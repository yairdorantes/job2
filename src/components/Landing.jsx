...
setImagePath(santacruz)
  ...
  return (
    <section className="relative">
      ...
      <a href="#">
      <img src={imagePath} alt="" className="cursor-pointer bg-white rounded-lg w-[185px] sm:w-[145px]  mx-auto " />
      </a>
      </div>
      <div
         style={{
       ...
       <img src={title} className="w-[450px]" alt="" />
        ...
        <div className="mt-10 text-center">
          <a href="#form-attendance">
            <button className="font-cinzel btn-chrismas1">Confirmar Asistencia</button>
          </a>
        </div>
